...
function year1891() {
  document.getElementById('changeImage').src = 'imgs/asteroid.png'
...
function year1978() {
  document.getElementById('changeImage').src = 'imgs/johnwaynegacy.webp'
...
function year2001() {
  document.getElementById('changeImage').src = 'imgs/richardcreid.jpg'
